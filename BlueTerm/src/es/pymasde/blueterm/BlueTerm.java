...
class TerminalEmulator {
    ...
    private void setAltCharSet(boolean alternateCharSet) {
        setmAlternateCharSet(alternateCharSet);
    }
    ...
    private void doSetMode(boolean newValue) {
        ...
        case 20:
            setmAutomaticNewlineMode(newValue);
            break;
    ...
    public void reset() {
        ...
        mSavedDecFlags = 0;
        mInsertMode = false;
        setmAutomaticNewlineMode(false);
        mTopMargin = 0;
        mBottomMargin = mRows;
        mAboutToAutoWrap = false;
        mForeColor = 7;
	...
	public static int getkWraparoundModeMask() {
		return K_WRAPAROUND_MODE_MASK;
	}

	public boolean ismAlternateCharSet() {
		return mAlternateCharSet;
	}

	public void setmAlternateCharSet(boolean mAlternateCharSet) {
		this.mAlternateCharSet = mAlternateCharSet;
	}

	public boolean ismAutomaticNewlineMode() {
		return mAutomaticNewlineMode;
	}

	public void setmAutomaticNewlineMode(boolean mAutomaticNewlineMode) {
		this.mAutomaticNewlineMode = mAutomaticNewlineMode;
	}
}
